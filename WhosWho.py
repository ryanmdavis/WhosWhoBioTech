...
class WhosWhoBioTech(object):
    ...
    def getTextAndKeywords(self,parent_directory):
        ...
        this_path = os.path.abspath(inspect.stack()[0][1])
        this_folder = this_path[:this_path.rfind('/')]
        corpus_directory = this_folder+'/FierceBiotech'
    ...
    def createTfidfTable(self,text_list):
        ...
        tfidf = TfidfVectorizer(tokenizer=self.tokenizeAndStemStrings, stop_words='english',ngram_range=(1,4), use_idf=True, smooth_idf = False, norm=None)
